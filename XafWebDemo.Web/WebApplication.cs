...
namespace XafWebDemo.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class XafWebDemoAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private XafWebDemo.Module.XafWebDemoModule module3;
        private XafWebDemo.Module.Web.XafWebDemoAspNetModule module4;
        ...
        public XafWebDemoAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void XafWebDemoAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new XafWebDemo.Module.XafWebDemoModule();
            this.module4 = new XafWebDemo.Module.Web.XafWebDemoAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(XafWebDemo.Module.BusinessObjects.ApplicationUser);
            // 
            // securityModule1
            // 
            this.securityModule1.UserType = typeof(XafWebDemo.Module.BusinessObjects.ApplicationUser);
            // 
            ...
            this.authenticationStandard1.UserLoginInfoType = typeof(XafWebDemo.Module.BusinessObjects.ApplicationUserLoginInfo);
            //
            // reportsModuleV2
            //
            ...
            // 
            // XafWebDemoAspNetApplication
            // 
            this.ApplicationName = "XafWebDemo";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.XafWebDemoAspNetApplication_DatabaseVersionMismatch);
